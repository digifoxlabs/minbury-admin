...
class TransactionUtil extends Util
{
    ...
    public function getLedgerDetails($contact_id, $start, $end, $format = 'format_1', $location_id = null, $line_details = false)
    {
        ...
        $expense_sum = $transactions->where('type', 'expense')->sum('final_total'); //Add Expesne Sum
        ...
        $total_expense_paid = ! empty($payments) ? $payments->where('transaction_type', 'expense')->where('is_return', 0)->sum('amount') : 0; 
        //Total Expense Paid
        ...
        // echo "total_excess_advance_payment".$total_excess_advance_payment;
        // echo "\n total_advance_payment".$total_advance_payment;

        // echo "\n total_paid". $total_paid;
        // echo "\n total_rxn_paid". $total_transactions_paid;
        // exit;
