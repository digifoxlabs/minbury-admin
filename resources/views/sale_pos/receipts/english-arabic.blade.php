    ...
    <div class="col-xs-12">
        <table class="table customer-info-table" style="width: 98%; font-size: 12px;">
            <tbody>
                ...
                <tr style="background: #2d2360;">
                    <td style="padding: 5px; font-weight: bold;text-align: right !important;">SHIPPING:</td>
                    <td class="print-red" style="padding: 5px;" colspan="4">
                        {!! $receipt_details->shipping_details !!}
                    </td>
                    <td style="padding: 5px; font-weight: bold;  direction: rtl; text-align: left !important;">تفاصيل الشحن:</td>
                </tr>
                @endif
                @if(!empty($receipt_details->shipping_address))
                <tr style="background: #2d2360;">
                    <td style="padding: 5px; font-weight: bold;text-align: right !important;">SHIP ADDR:</td>
                    <td class="print-red" style="padding: 5px;" colspan="4">
                        {!! $receipt_details->shipping_address !!}
                    </td>
                    <td style="padding: 5px; font-weight: bold;  direction: rtl; text-align: left !important;">عنوان الشحن:</td>
                </tr>
                @endif
            </tbody>
        </table>
