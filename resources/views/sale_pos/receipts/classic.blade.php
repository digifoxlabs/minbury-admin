...
<div class="row" style="color: #000000 !important;">
		...
		@endif
	<div class="col-xs-12">
		<!-- Invoice number, customer details, date and shipping details -->
		<div class="row" style="width: 100%; margin: 0;">
			<div class="col-xs-7 text-left word-wrap" style="padding-left: 0;">
			...
			<div class="col-xs-5 text-right" style="padding-right: 0;">
				<div style="display: block; clear: both; width: 220px; margin-left: auto; text-align: right; white-space: normal;">
				...
				@if(!empty($receipt_details->shipping_details))
					<div style="display: block; clear: both; width: 220px; margin: 4px 0 0 auto; text-align: right; white-space: normal;">
						<strong>{!! $receipt_details->shipping_details_label ?? __('sale.shipping_details') !!}:</strong>
