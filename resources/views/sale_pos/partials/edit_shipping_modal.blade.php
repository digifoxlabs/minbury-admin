		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row">
				    ...
				    <div class="col-md-6">
				        <div class="form-group">
				            {!! Form::label('contact_shipping_address_id', 'Saved shipping addresses:' ) !!}
				            {!! Form::select('contact_shipping_address_id', [], null, ['class' => 'form-control select2', 'style' => 'width:100%', 'id' => 'contact_shipping_address_id', 'placeholder' => __('messages.please_select')]); !!}
				        </div>
				    </div>
				    ...
				    @php
                        ...
                        $shipping_custom_field_values = [
                            'shipping_custom_field_1' => !empty($transaction->shipping_custom_field_1) ? $transaction->shipping_custom_field_1 : (!empty($walk_in_customer['shipping_custom_field_details']['shipping_custom_field_1']) ? $walk_in_customer['shipping_custom_field_details']['shipping_custom_field_1'] : null),
                            'shipping_custom_field_2' => !empty($transaction->shipping_custom_field_2) ? $transaction->shipping_custom_field_2 : (!empty($walk_in_customer['shipping_custom_field_details']['shipping_custom_field_2']) ? $walk_in_customer['shipping_custom_field_details']['shipping_custom_field_2'] : null),
                            'shipping_custom_field_3' => !empty($transaction->shipping_custom_field_3) ? $transaction->shipping_custom_field_3 : (!empty($walk_in_customer['shipping_custom_field_details']['shipping_custom_field_3']) ? $walk_in_customer['shipping_custom_field_details']['shipping_custom_field_3'] : null),
                            'shipping_custom_field_4' => !empty($transaction->shipping_custom_field_4) ? $transaction->shipping_custom_field_4 : (!empty($walk_in_customer['shipping_custom_field_details']['shipping_custom_field_4']) ? $walk_in_customer['shipping_custom_field_details']['shipping_custom_field_4'] : null),
                            'shipping_custom_field_5' => !empty($transaction->shipping_custom_field_5) ? $transaction->shipping_custom_field_5 : (!empty($walk_in_customer['shipping_custom_field_details']['shipping_custom_field_5']) ? $walk_in_customer['shipping_custom_field_details']['shipping_custom_field_5'] : null),
                        ];
			        ...
			        @if(!empty($shipping_custom_label_1))
			        	...
			        	<div class="col-md-6">
					        <div class="form-group">
					            ...
					            {!! Form::text('shipping_custom_field_1', $shipping_custom_field_values['shipping_custom_field_1'], ['class' => 'form-control','placeholder' => $shipping_custom_label_1, 'required' => $is_shipping_custom_field_1_required]); !!}
					        </div>
					    </div>
			        @endif
			        @if(!empty($shipping_custom_label_2))
			        	...
			        	<div class="col-md-6">
					        <div class="form-group">
					            ...
					            {!! Form::text('shipping_custom_field_2', $shipping_custom_field_values['shipping_custom_field_2'], ['class' => 'form-control','placeholder' => $shipping_custom_label_2, 'required' => $is_shipping_custom_field_2_required]); !!}
					        </div>
					    </div>
			        @endif
			        @if(!empty($shipping_custom_label_3))
			        	...
			        	<div class="col-md-6">
					        <div class="form-group">
					            ...
					            {!! Form::text('shipping_custom_field_3', $shipping_custom_field_values['shipping_custom_field_3'], ['class' => 'form-control','placeholder' => $shipping_custom_label_3, 'required' => $is_shipping_custom_field_3_required]); !!}
					        </div>
					    </div>
			        @endif
			        @if(!empty($shipping_custom_label_4))
			        	...
			        	<div class="col-md-6">
					        <div class="form-group">
					            ...
					            {!! Form::text('shipping_custom_field_4', $shipping_custom_field_values['shipping_custom_field_4'], ['class' => 'form-control','placeholder' => $shipping_custom_label_4, 'required' => $is_shipping_custom_field_4_required]); !!}
					        </div>
					    </div>
			        @endif
			        @if(!empty($shipping_custom_label_5))
			        	...
			        	<div class="col-md-6">
					        <div class="form-group">
					            ...
					            {!! Form::text('shipping_custom_field_5', $shipping_custom_field_values['shipping_custom_field_5'], ['class' => 'form-control','placeholder' => $shipping_custom_label_5, 'required' => $is_shipping_custom_field_5_required]); !!}
					        </div>
					    </div>
			        @endif
				</div>
