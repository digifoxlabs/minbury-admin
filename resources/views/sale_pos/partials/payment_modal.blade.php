...
<!-- Used for express checkout UPI transaction -->
<div class="modal fade" tabindex="-1" role="dialog" id="upi_details_modal">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                        aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">@lang('lang_v1.upi_transaction_details')</h4>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">

                         <p class="info-box-number">Accept UPI Payment of Rs. <span id="total_payable"></span></p>	

                    </div>
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="tw-dw-btn tw-dw-btn-primary tw-text-white" id="pos-save-upi">@lang('sale.finalize_payment')</button>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                         ...
                         <p class="info-box-number">Accept CARD Payment of Rs. <span id="total_payable"></span></p>	
...
<!-- Used for express checkout card transaction -->
<div class="modal fade" tabindex="-1" role="dialog" id="card_details_modalX">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
