	...
	<div class="col-md-4">
		<div class="form-group" style="width: 100% !important">
			<div class="input-group">
				...
				value="{{ $transaction->shipping_address ?? $transaction->contact->shipping_address }}" >
				<input type="hidden" id="default_customer_shipping_addresses"
				value='@json(optional($transaction->contact)->shippingAddresses ?? [])'>
