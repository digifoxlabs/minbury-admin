				...
				<div class="@if(!empty($commission_agent)) col-sm-3 @else col-sm-4 @endif">
					<div class="form-group">
						...
						<div class="input-group">
							...
							<input type="hidden" id="default_customer_address" value="{{ $transaction->shipping_address ?? '' }}">
							<input type="hidden" id="default_customer_shipping_addresses" value="{{ e(json_encode(!empty($transaction->contact) ? $transaction->contact->shippingAddresses->values()->toArray() : [])) }}">
